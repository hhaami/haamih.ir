        ...
        const portfolioData = [
            {
                id: 1,
                title: 'HamAI',
                description: 'A simple chatbot used for simple tasks',
                image: 'images/neural-network.jpg',
                tech: ['Python', 'CUDA', 'Closed Beta']
            },
            {
                id: 2,
                title: 'HamOS',
                description: 'Next-generation operating system built for developers (basicly HamTerminal).',
                image: 'images/quantum-cloud.jpg',
                tech: ['GRUB', 'C', 'In Progress']
            },
            {
                id: 3,
                title: 'HamTerminal',
                description: 'Next-generation terminal which makes coding easy.',
        ...
        function createCarouselItem(data, index) {
            ...
            item.innerHTML = `
                <div class="card">
                    ...
                    <button class="card-cta" onclick="scrollToSection('about')">Learn More</button>
                </div>
            `;
